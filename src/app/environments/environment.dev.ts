export const environment = {
    production: false,
    BASE_URL: 'http://localhost:3009/',  //URL
    ADMIN_URL: 'http://localhost:3009/admin/',
    USER_URL: 'http://localhost:3009/users/',
    // BASE_URL: 'http://192.168.0.132:3009/',  //URL
    // ADMIN_URL: 'http://192.168.0.132:3009/',
    // USER_URL: 'http://192.168.0.132:3009/',
